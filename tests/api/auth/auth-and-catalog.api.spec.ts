...
test(
  `API returns product list with filter and sort ${tags(
    TAGS.testType.api,
...
test(
  `API login succeeds with valid credentials ${tags(
    TAGS.testType.api,
...
test(
  `API login fails with invalid credentials ${tags(
    TAGS.testType.api,
    TAGS.executionScope.critical,
...
test(
  `API rejects invalid coupon code ${tags(
    TAGS.testType.api,
...
test(
  `API rejects unauthorized orders endpoint ${tags(
    TAGS.testType.api,
    TAGS.executionScope.critical,
    TAGS.caseStyle.negative,
    TAGS.dataImpact.safe,
